...
[![winamd64/odoo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/odoo.svg?label=winamd64/odoo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/odoo/)
...
```console
$ docker run -p 8069:8069 --name odoo --link db:db -t winamd64/odoo
```
...
```console
$ docker run -v /path/to/config:/etc/odoo -p 8069:8069 --name odoo --link db:db -t winamd64/odoo
```
...
```console
$ docker run -p 8069:8069 --name odoo --link db:db -t winamd64/odoo -- --db-filter=odoo_db_.*
```
...
```console
$ docker run -v /path/to/addons:/mnt/extra-addons -p 8069:8069 --name odoo --link db:db -t winamd64/odoo
```

## Run multiple Odoo instances

```console
$ docker run -p 8070:8069 --name odoo2 --link db:db -t winamd64/odoo
$ docker run -p 8071:8069 --name odoo3 --link db:db -t winamd64/odoo
```
...
```console
$ docker run --volumes-from old-odoo -p 8070:8069 --name new-odoo --link db:db -t winamd64/odoo
```
