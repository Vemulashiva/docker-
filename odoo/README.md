...
[![arm64v8/odoo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/odoo.svg?label=arm64v8/odoo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/odoo/)
...
```console
$ docker run --volumes-from old-odoo -p 8070:8069 --name new-odoo --link db:db -t arm64v8/odoo
```
