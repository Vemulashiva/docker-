...
[![arm32v6/clefos build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/clefos.svg?label=arm32v6/clefos%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/clefos/)
...
The `arm32v6/clefos:latest` tag is always the most recent version currently available.
...
Systemd is not included in both the `arm32v6/clefos:7` and `arm32v6/clefos:latest` base containers, but can be created from these bases:

### Dockerfile for systemd base image

```dockerfile
FROM 		arm32v6/clefos:7
