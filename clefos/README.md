...
[![ppc64le/clefos build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clefos.svg?label=ppc64le/clefos%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clefos/)
...
The `ppc64le/clefos:latest` tag is always the most recent version currently available.
...
Systemd is not included in both the `ppc64le/clefos:7` and `ppc64le/clefos:latest` base containers, but can be created from these bases:

### Dockerfile for systemd base image

```dockerfile
FROM 		ppc64le/clefos:7
