...
[![i386/clefos build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/clefos.svg?label=i386/clefos%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/clefos/)
...
The `i386/clefos:latest` tag is always the most recent version currently available.
...
Systemd is not included in both the `i386/clefos:7` and `i386/clefos:latest` base containers, but can be created from these bases:
