...
[![amd64/clefos build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/amd64/job/clefos.svg?label=amd64/clefos%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/clefos/)
...
The `amd64/clefos:latest` tag is always the most recent version currently available.
...
Systemd is not included in both the `amd64/clefos:7` and `amd64/clefos:latest` base containers, but can be created from these bases:
