...
[![arm32v7/clojure build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/clojure.svg?label=arm32v7/clojure%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/clojure/)
...
```console
$ docker run -it --rm -v "$PWD":/usr/src/app -w /usr/src/app arm32v7/clojure lein uberjar
```
