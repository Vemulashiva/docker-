...
[![winamd64/clojure build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/clojure.svg?label=winamd64/clojure%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/clojure/)
...
```console
$ docker run -it --rm -v "$PWD":/usr/src/app -w /usr/src/app winamd64/clojure lein uberjar
```
