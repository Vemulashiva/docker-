...
[![winamd64/registry build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/registry.svg?label=winamd64/registry%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/registry/)
...
```console
$ docker run -d -p 5000:5000 --restart always --name registry winamd64/registry:2
```
