...
[![arm32v5/registry build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/registry.svg?label=arm32v5/registry%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/registry/)
...
```console
$ docker run -d -p 5000:5000 --restart always --name registry arm32v5/registry:2
```
