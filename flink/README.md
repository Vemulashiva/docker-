...
[![s390x/flink build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/flink.svg?label=s390x/flink%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/flink/)
