...
$ docker run --name some-postfixadmin -v /local/path/to/config.local.php:/var/www/html/config.local.php -p 8080:80 arm64v8/postfixadmin
```
...
## `arm64v8/postfixadmin:<version>-alpine`
