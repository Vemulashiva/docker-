...
$ docker run --name some-postfixadmin -v /local/path/to/config.local.php:/var/www/html/config.local.php -p 8080:80 arm32v7/postfixadmin
```
...
## `arm32v7/postfixadmin:<version>-alpine`
