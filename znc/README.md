...
[![i386/znc build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/znc.svg?label=i386/znc%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/znc/)
...
```console
$ docker run -it -v znc-cfg:/znc-data i386/znc --makeconf
```

To run ZNC:

```console
$ docker run -p 6697:6697 -v znc-cfg:/znc-data i386/znc
```
