...
[![arm32v5/znc build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/znc.svg?label=arm32v5/znc%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/znc/)
...
```console
$ docker run -p 6697:6697 -v znc-cfg:/znc-data arm32v5/znc
```
