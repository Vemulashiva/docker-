...
[![winamd64/znc build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/znc.svg?label=winamd64/znc%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/znc/)
...
```console
$ docker run -it -v znc-cfg:/znc-data winamd64/znc --makeconf
```

To run ZNC:

```console
$ docker run -p 6697:6697 -v znc-cfg:/znc-data winamd64/znc
```
