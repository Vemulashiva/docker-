...
[![ppc64le/gazebo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/gazebo.svg?label=ppc64le/gazebo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/gazebo/)
...
```console
$ docker run -v "/home/ubuntu/.gazebo/:/root/.gazebo/" ppc64le/gazebo
```
...
```console
$ docker run -d -v="/tmp/.gazebo/:/root/.gazebo/" --name=gazebo ppc64le/gazebo
```
...
```console
$ docker exec -it ppc64le/gazebo bash
