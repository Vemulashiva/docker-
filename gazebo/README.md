...
[![arm32v6/gazebo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/gazebo.svg?label=arm32v6/gazebo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/gazebo/)
...
```console
$ docker run -v "/home/ubuntu/.gazebo/:/root/.gazebo/" arm32v6/gazebo
```
...
```console
$ docker run -d -v="/tmp/.gazebo/:/root/.gazebo/" --name=gazebo arm32v6/gazebo
```
...
```console
$ docker exec -it arm32v6/gazebo bash
