...
[![winamd64/joomla build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/joomla.svg?label=winamd64/joomla%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/joomla/)
...
```console
$ docker run --name some-joomla --link some-mysql:mysql -d winamd64/joomla
```
...
```console
$ docker run --name some-joomla --link some-mysql:mysql -p 8080:80 -d winamd64/joomla
```
