...
[![amd64/swarm build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/amd64/job/swarm.svg?label=amd64/swarm%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/swarm/)
...
```bash
# create a cluster
$ docker run --rm amd64/swarm create
6856663cdefdec325839a4b7e1de38e8 # <- this is your unique <cluster_id>

# on each of your nodes, start the swarm agent
#  <node_ip> doesn't have to be public (eg. 192.168.0.X),
#  as long as the swarm manager can access it.
$ docker run -d amd64/swarm join --addr=<node_ip:2375> token://<cluster_id>

# start the manager on any machine or your laptop
$ docker run -t -p <swarm_port>:2375 -t amd64/swarm manage token://<cluster_id>
...
$ docker run --rm amd64/swarm list token://<cluster_id>
<node_ip:2375>
```
