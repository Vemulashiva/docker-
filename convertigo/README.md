...
```console
$ docker run -d --name C8O-MBAAS -e JAVA_OPTS="-DjvmRoute=server1" -p 28080:28080 arm32v5/convertigo
```
...
```console
$ docker run -d --name C8O-MBAAS -e JXMX="4096" -p 28080:28080 arm32v5/convertigo
```
...
```console
$ docker run -d --name C8O-MBAAS -e COOKIE_PATH="/convertigo" -p 28080:28080 arm32v5/convertigo
```
