...
[![arm32v6/memcached build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/memcached.svg?label=arm32v6/memcached%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/memcached/)
...
```console
$ docker run --name my-memcache -d arm32v6/memcached
```

## Setting Memory Usage

```console
$ docker run --name my-memcache -d arm32v6/memcached memcached -m 64
```
...
The `arm32v6/memcached` images come in many flavors, each designed for a specific use case.

## `arm32v6/memcached:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `arm32v6/memcached:<version>-alpine`
