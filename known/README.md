...
[![s390x/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/known.svg?label=s390x/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/known/)
