...
[![amd64/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/amd64/job/known.svg?label=amd64/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/known/)
...
```bash
docker run --link some-mysql:db -d amd64/known
```
