...
[![arm32v6/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/known.svg?label=arm32v6/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/known/)
...
```bash
docker run --link some-mysql:db -d arm32v6/known
```
