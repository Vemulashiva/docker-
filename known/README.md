...
[![arm32v5/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/known.svg?label=arm32v5/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/known/)
...
```bash
docker run --link some-mysql:db -d arm32v5/known
```
