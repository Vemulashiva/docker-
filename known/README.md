...
[![ppc64le/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/known.svg?label=ppc64le/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/known/)
...
```bash
docker run --link some-mysql:db -d ppc64le/known
```
