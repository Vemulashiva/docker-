...
[![s390x/nuxeo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/nuxeo.svg?label=s390x/nuxeo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/nuxeo/)
...
```console
$ docker run --name mynuxeo -p 8080:8080 -d s390x/nuxeo
```
