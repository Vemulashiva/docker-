...
[![i386/nuxeo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/nuxeo.svg?label=i386/nuxeo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/nuxeo/)
...
```console
$ docker run --name mynuxeo -p 8080:8080 -d i386/nuxeo
```
