...
[![ppc64le/clearlinux build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clearlinux.svg?label=ppc64le/clearlinux%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clearlinux/)
...
The `ppc64le/clearlinux:latest` tag will point to `ppc64le/clearlinux:base` which will track toward the latest release version of the distribution.
