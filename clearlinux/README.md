...
[![s390x/clearlinux build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/clearlinux.svg?label=s390x/clearlinux%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/clearlinux/)
