...
[![winamd64/clearlinux build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/clearlinux.svg?label=winamd64/clearlinux%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/clearlinux/)
...
The `winamd64/clearlinux:latest` tag will point to `winamd64/clearlinux:base` which will track toward the latest release version of the distribution.
