...
[![arm64v8/sourcemage build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/sourcemage.svg?label=arm64v8/sourcemage%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/sourcemage/)
...
```shell
$ docker run -it arm64v8/sourcemage
```

or

```shell
$ docker run -it arm64v8/sourcemage:0.62
```
