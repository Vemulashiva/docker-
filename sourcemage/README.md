...
[![i386/sourcemage build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/sourcemage.svg?label=i386/sourcemage%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/sourcemage/)
...
```shell
$ docker run -it i386/sourcemage
```

or

```shell
$ docker run -it i386/sourcemage:0.62
```
