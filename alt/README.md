...
[![s390x/alt build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/alt.svg?label=s390x/alt%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/alt/)
...
The `s390x/alt:latest` tag will always point the latest stable release (which is, at the time of this writing, `s390x/alt:p9`).
