...
[![arm32v6/yourls build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/yourls.svg?label=arm32v6/yourls%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/yourls/)
...
```console
$ docker run --name some-yourls --link some-mysql:mysql -p 8080:80 -d arm32v6/yourls
```
...
$ docker run --name some-yourlss -e YOURLS_DB_HOST=10.1.2.3:3306 \
    -e YOURLS_DB_USER=... -e YOURLS_DB_PASS=... -d arm32v6/yourls
```
