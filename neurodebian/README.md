...
[![arm32v6/neurodebian build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/neurodebian.svg?label=arm32v6/neurodebian%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/neurodebian/)
...
The `arm32v6/neurodebian:latest` tag will always point the Neurodebian-enabled latest stable release of Debian (which is, at the time of this writing, `debian:wheezy`).
...
```console
$ docker run arm32v6/neurodebian cat /etc/apt/sources.list.d/neurodebian.sources.list
