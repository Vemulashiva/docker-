...
[![winamd64/ros build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/ros.svg?label=winamd64/ros%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/ros/)
...
```console
$ docker run -v "/home/ubuntu/.ros/:/root/.ros/" winamd64/ros
```
...
```dockerfile
FROM winamd64/ros:indigo-ros-base
...
```console
$ docker build --tag winamd64/ros:ros-tutorials .
```
