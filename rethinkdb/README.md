...
[![arm64v8/rethinkdb build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/rethinkdb.svg?label=arm64v8/rethinkdb%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/rethinkdb/)
...
```bash
docker run --name some-rethink -v "$PWD:/data" -d arm64v8/rethinkdb
```
