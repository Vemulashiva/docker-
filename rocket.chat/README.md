...
[![winamd64/rocket.chat build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/rocket.chat.svg?label=winamd64/rocket.chat%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/rocket.chat/)
...
```console
$ docker run --name rocketchat --link db -d winamd64/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --link db -d winamd64/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --env MONGO_URL=mongodb://mymongourl/mydb -d winamd64/rocket.chat
```
