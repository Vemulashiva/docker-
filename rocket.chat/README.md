...
```console
$ docker run --name rocketchat --link db -d arm32v6/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --link db -d arm32v6/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --env MONGO_URL=mongodb://mymongourl/mydb -d arm32v6/rocket.chat
```
