...
[![arm64v8/rocket.chat build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/rocket.chat.svg?label=arm64v8/rocket.chat%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/rocket.chat/)
...
```console
$ docker run --name rocketchat --link db -d arm64v8/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --link db -d arm64v8/rocket.chat
```
...
```console
$ docker run --name rocketchat -p 80:3000 --env ROOT_URL=http://localhost --env MONGO_URL=mongodb://mymongourl/mydb -d arm64v8/rocket.chat
```
