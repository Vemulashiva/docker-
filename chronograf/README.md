...
[![i386/chronograf build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/chronograf.svg?label=i386/chronograf%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/chronograf/)
...
```console
$ docker run -p 8888:8888 i386/chronograf
```
...
$ docker run -p 8888:8888 \
      --net=influxdb \
      i386/chronograf --influxdb-url=http://influxdb:8086
```
