...
[![winamd64/chronograf build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/chronograf.svg?label=winamd64/chronograf%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/chronograf/)
...
```console
$ docker run -p 8888:8888 winamd64/chronograf
```
...
$ docker run -p 8888:8888 \
      --net=influxdb \
      winamd64/chronograf --influxdb-url=http://influxdb:8086
```
