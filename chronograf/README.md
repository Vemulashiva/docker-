...
[![ppc64le/chronograf build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/chronograf.svg?label=ppc64le/chronograf%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/chronograf/)
