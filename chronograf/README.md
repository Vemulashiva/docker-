...
[![arm32v6/chronograf build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/chronograf.svg?label=arm32v6/chronograf%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/chronograf/)
...
```console
$ docker run -p 8888:8888 arm32v6/chronograf
```
...
$ docker run -p 8888:8888 \
      --net=influxdb \
      arm32v6/chronograf --influxdb-url=http://influxdb:8086
```
