...
[![arm32v5/solr build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/solr.svg?label=arm32v5/solr%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/solr/)
...
```console
$ docker run -p 8983:8983 -t arm32v5/solr
```
