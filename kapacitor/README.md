...
[![arm32v6/kapacitor build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/kapacitor.svg?label=arm32v6/kapacitor%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/kapacitor/)
...
```console
$ docker run -p 9092:9092 arm32v6/kapacitor
```
...
```console
$ docker run --rm arm32v6/kapacitor kapacitord config > kapacitor.conf
```
...
```console
$ docker run --name=kapacitor -d -p 9092:9092 arm32v6/kapacitor
```
