...
[![i386/kapacitor build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/kapacitor.svg?label=i386/kapacitor%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/kapacitor/)
...
```console
$ docker run -p 9092:9092 i386/kapacitor
```
...
```console
$ docker run --rm i386/kapacitor kapacitord config > kapacitor.conf
```
...
```console
$ docker run --name=kapacitor -d -p 9092:9092 i386/kapacitor
```
