...
[![winamd64/kapacitor build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/kapacitor.svg?label=winamd64/kapacitor%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/kapacitor/)
...
```console
$ docker run -p 9092:9092 winamd64/kapacitor
```
...
```console
$ docker run --rm winamd64/kapacitor kapacitord config > kapacitor.conf
```
...
```console
$ docker run --name=kapacitor -d -p 9092:9092 winamd64/kapacitor
```
