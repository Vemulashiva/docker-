...
[![arm32v6/rakudo-star build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/rakudo-star.svg?label=arm32v6/rakudo-star%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/rakudo-star/)
...
```console
$ docker run -it arm32v6/rakudo-star
> say 'Hello, Perl!'
Hello, Perl!
```
...
```console
$ docker run -it arm32v6/rakudo-star -e 'say "Hello!"'
```
