...
[![winamd64/rakudo-star build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/rakudo-star.svg?label=winamd64/rakudo-star%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/rakudo-star/)
...
```console
$ docker run -it winamd64/rakudo-star
> say 'Hello, Perl!'
Hello, Perl!
```
...
```console
$ docker run -it winamd64/rakudo-star -e 'say "Hello!"'
```
