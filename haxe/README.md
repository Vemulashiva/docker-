...
[![ppc64le/haxe build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/haxe.svg?label=ppc64le/haxe%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/haxe/)
...
Rewriting the above Dockerfile with `ppc64le/haxe:3.4-onbuild`, we will get:

```dockerfile
FROM ppc64le/haxe:3.4-onbuild
