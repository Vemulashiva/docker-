...
[![arm32v6/haxe build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/haxe.svg?label=arm32v6/haxe%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/haxe/)
...
Rewriting the above Dockerfile with `arm32v6/haxe:3.4-onbuild`, we will get:

```dockerfile
FROM arm32v6/haxe:3.4-onbuild
