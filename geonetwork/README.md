...
[![arm32v6/geonetwork build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/geonetwork.svg?label=arm32v6/geonetwork%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/geonetwork/)
...
```console
$ docker run --name some-geonetwork -d arm32v6/geonetwork
```
...
```console
$ docker run --name some-geonetwork -d -p 8080:8080 arm32v6/geonetwork
```
...
```console
$ docker run --name some-geonetwork -d -p 8080:8080 -e DATA_DIR=/var/lib/geonetwork_data arm32v6/geonetwork
```
...
```console
$ docker run --name some-geonetwork -d -p 8080:8080 -e DATA_DIR=/var/lib/geonetwork_data -v /host/geonetwork-docker:/var/lib/geonetwork_data arm32v6/geonetwork
```
