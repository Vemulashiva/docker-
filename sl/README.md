...
[![i386/sl build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/sl.svg?label=i386/sl%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/sl/)
...
```console
$ docker pull i386/sl
$ docker run -it i386/sl:6 cat /etc/redhat-release
$ docker run -it i386/sl:7 cat /etc/redhat-release
```
