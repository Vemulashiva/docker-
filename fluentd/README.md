...
[![arm64v8/fluentd build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/fluentd.svg?label=arm64v8/fluentd%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/fluentd/)
...
```bash
$ docker run -p 24224:24224 -p 24224:24224/udp -u fluent -v /path/to/dir:/fluentd/log arm64v8/fluentd
