...
-	[`develop`](https://github.com/eggheads/eggdrop-docker/blob/51d2fa5962ba517ba83f2e9b9da2913ce94392ba/develop/Dockerfile)

[![arm64v8/eggdrop build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/eggdrop.svg?label=arm64v8/eggdrop%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/eggdrop/)
...
```console
$ docker run -ti -e NICK=FooBot -e SERVER=irc.freenode.net -v /path/for/host/data:/home/eggdrop/eggdrop/data arm64v8/eggdrop
```
...
```console
$ docker run -i -e NICK=FooBot -e SERVER=irc.freenode.net -v /path/to/eggdrop/files:/home/eggdrop/eggdrop/data -d arm64v8/eggdrop
```

If you provide your own config file, specify it as the argument to the docker container:

```console
$ docker run -i -v /path/to/eggdrop/files:/home/eggdrop/eggdrop/data -d arm64v8/eggdrop mybot.conf
```
