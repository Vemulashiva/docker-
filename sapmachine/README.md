...
[![arm32v5/sapmachine build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/sapmachine.svg?label=arm32v5/sapmachine%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/sapmachine/)
...
```console
docker pull arm32v5/sapmachine:latest
docker run -it arm32v5/sapmachine:latest java -version
```

You can also use the SapMachine image as a base image to run your own jar file:

```dockerfile
FROM arm32v5/sapmachine:latest
RUN mkdir /opt/myapp
