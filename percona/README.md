...
[![arm32v5/percona build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/percona.svg?label=arm32v5/percona%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/percona/)
...
```console
$ docker run --name some-percona -v /my/custom:/etc/mysql/conf.d -e MYSQL_ROOT_PASSWORD=my-secret-pw -d arm32v5/percona:tag
```
