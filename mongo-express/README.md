...
[![arm64v8/mongo-express build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/mongo-express.svg?label=arm64v8/mongo-express%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/mongo-express/)
...
```console
$ docker run --network some-network -e ME_CONFIG_MONGODB_SERVER=some-mongo -p 8081:8081 arm64v8/mongo-express
```
