...
[![arm32v6/mongo-express build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/mongo-express.svg?label=arm32v6/mongo-express%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/mongo-express/)
...
```console
$ docker run --network some-network -e ME_CONFIG_MONGODB_SERVER=some-mongo -p 8081:8081 arm32v6/mongo-express
```
