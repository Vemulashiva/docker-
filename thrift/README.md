...
[![winamd64/thrift build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/thrift.svg?label=winamd64/thrift%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/thrift/)
...
```console
$ docker run -v "$PWD:/data" winamd64/thrift thrift -o /data --gen rb /data/service.thrift
```
