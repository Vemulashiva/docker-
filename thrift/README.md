...
[![i386/thrift build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/thrift.svg?label=i386/thrift%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/thrift/)
...
```console
$ docker run -v "$PWD:/data" i386/thrift thrift -o /data --gen rb /data/service.thrift
```
