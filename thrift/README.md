...
[![arm32v6/thrift build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/thrift.svg?label=arm32v6/thrift%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/thrift/)
...
```console
$ docker run -v "$PWD:/data" arm32v6/thrift thrift -o /data --gen rb /data/service.thrift
```
