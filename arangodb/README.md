...
[![s390x/arangodb build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/arangodb.svg?label=s390x/arangodb%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/arangodb/)
