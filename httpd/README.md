...
[![winamd64/httpd build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/httpd.svg?label=winamd64/httpd%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/httpd/)
...
```console
$ docker run -dit --name my-apache-app -p 8080:80 -v "$PWD":/usr/local/apache2/htdocs/ winamd64/httpd:2.4
```
