...
[![arm32v5/rapidoid build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/rapidoid.svg?label=arm32v5/rapidoid%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/rapidoid/)
...
```console
$ docker run --rm arm32v5/rapidoid --help
```
