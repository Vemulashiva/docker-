...
[![i386/rapidoid build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/rapidoid.svg?label=i386/rapidoid%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/rapidoid/)
...
```console
$ docker run --rm i386/rapidoid --help
```
