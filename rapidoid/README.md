...
[![arm32v6/rapidoid build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/rapidoid.svg?label=arm32v6/rapidoid%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/rapidoid/)
...
```console
$ docker run --rm arm32v6/rapidoid --help
```
