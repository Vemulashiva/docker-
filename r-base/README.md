...
[![winamd64/r-base build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/r-base.svg?label=winamd64/r-base%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/r-base/)
...
```console
$ docker run -ti --rm winamd64/r-base
```
...
```console
$ docker run -ti --rm -v "$PWD":/home/docker -w /home/docker -u docker winamd64/r-base R CMD check .
```
...
```console
$ docker run -ti --rm winamd64/r-base /usr/bin/bash
$ vim.tiny myscript.R
```
