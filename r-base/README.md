...
[![arm32v5/r-base build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/r-base.svg?label=arm32v5/r-base%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/r-base/)
...
```console
$ docker run -ti --rm arm32v5/r-base
```
...
```console
$ docker run -ti --rm -v "$PWD":/home/docker -w /home/docker -u docker arm32v5/r-base R CMD check .
```
...
```console
$ docker run -ti --rm arm32v5/r-base /usr/bin/bash
$ vim.tiny myscript.R
```
