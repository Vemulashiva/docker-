...
[![i386/r-base build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/r-base.svg?label=i386/r-base%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/r-base/)
...
```console
$ docker run -ti --rm -v "$PWD":/home/docker -w /home/docker -u docker i386/r-base R CMD check .
```
...
```console
$ docker run -ti --rm i386/r-base /usr/bin/bash
$ vim.tiny myscript.R
```
